  ...
  .info {
    ...
    ul {
      ...
      .block_height {
        width: 44px;
        height: 44px;
        background: url("../../assets/imagesen/second/区块高度.png") no-repeat
          center/100% 100%;
      }
      // .block_height:hover {
      //   width: 44px;
      //   height: 44px;
      //   background: url("../../assets/imagesen/second/区块高度.gif") no-repeat
      //     center/100% 100%;
      // }
      .transaction24 {
        width: 44px;
        height: 44px;
        background: url("../../assets/imagesen/second/24H交易数.png") no-repeat
          center/100% 100%;
      }
      // .transaction24:hover {
      //   width: 44px;
      //   height: 44px;
      //   background: url("../../assets/imagesen/second/24H交易数.gif") no-repeat
      //     center/100% 100%;
      // }
      .award {
        width: 44px;
        height: 44px;
        background: url("../../assets/imagesen/second/已发放奖励.png") no-repeat
          center/100% 100%;
      }
      // .award:hover {
      //   width: 44px;
      //   height: 44px;
      //   background: url("../../assets/imagesen/second/已发放奖励.gif") no-repeat
      //     center/100% 100%;
      // }
      .alljiedian {
        width: 44px;
        height: 44px;
        background: url("../../assets/imagesen/second/节点总数.png") no-repeat
          center/100% 100%;
      }
      // .alljiedian:hover {
      //   width: 44px;
      //   height: 44px;
      //   background: url("../../assets/imagesen/second/节点总数.gif") no-repeat
      //     center/100% 100%;
      // }
      .alltransaction {
        width: 44px;
        height: 44px;
        background: url("../../assets/imagesen/second/累计交易数.png") no-repeat
          center/100% 100%;
      }
      // .alltransaction:hover {
      //   width: 44px;
      //   height: 44px;
      //   background: url("../../assets/imagesen/second/累计交易数.gif") no-repeat
      //     center/100% 100%;
      // }
      .last_award {
        width: 44px;
        height: 44px;
        background: url("../../assets/imagesen/second/剩余区块奖励.png") no-repeat
          center/100% 100%;
      }
      // .last_award:hover {
      //   width: 44px;
      //   height: 44px;
      //   background: url("../../assets/imagesen/second/剩余区块奖励.gif") no-repeat
      //     center/100% 100%;
      // }
    }
    .center_bottom {
