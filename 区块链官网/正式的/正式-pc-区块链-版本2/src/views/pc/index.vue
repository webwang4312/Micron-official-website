    ...
    indexlists() {
      ...
      that.$http
        ...
        .then((res) => {
          ...
          //区块高度
          this.blockheigth =
            data.block_height_all[0].block_height;
          // 区块奖励
