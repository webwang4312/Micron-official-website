...
export default {
  ...
  methods: {
    drawLine() {
      ...
      let myChart = echarts.init(document.getElementById("total_number_accounts"));
     ...
     this.$http
        .get("/show_graph_data")
        .then((res) => {
        for (var i = 0; i < res.data[0].account_number_statistics.length + 1; i++) {
        ...
        .get("/show_graph_data")
        .then((res) => {
        for (var s = 0; s < res.data[0].new_account_statistics.length + 1; s++) {
        ...
        .get("/show_graph_data")
        .then((res) => {
        for (var m = 0; m < res.data[0].active_user_statistics.length + 1; m++) {
